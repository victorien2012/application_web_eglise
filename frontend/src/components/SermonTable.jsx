  ...
  return (
    <div className="datatable-responsive">
      <table className="premium-table">
        <thead>
          <tr>
            <th>{t('dashboard.col_image', 'Image')}</th>
            <th>{t('dashboard.col_date_predication', 'Date de prédication')}</th>
            <th>{t('dashboard.col_title', 'Titre')}</th>
            <th>{t('videos.th_pastor', 'Pasteur')}</th>
            {showStatus && <th>{t('dashboard.col_status', 'Statut')}</th>}
            <th>{t('dashboard.col_publication', 'Date de publication')}</th>
            <th style={{ textAlign: 'right' }}>{t('dashboard.col_actions', 'Actions')}</th>
            {showCheckbox && (
