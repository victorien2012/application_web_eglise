...
import {
  ...
  Loader2, UserRound, LogIn, BookOpen, CheckCircle2,
} from 'lucide-react';
...
export function Profil() {
  ...
  const confirmerSuppressionCompte = () => {
    confirmDialog({
      message: (
        <>
          {t('profile.delete_confirm')}<br/><br/>
      ...
      header: t('profile.personal_data') || 'Confirmation',
      icon: 'pi pi-exclamation-triangle',
      defaultFocus: 'reject',
      acceptClassName: 'p-button-danger',
      rejectClassName: 'p-button-text',
      acceptLabel: t('profile.delete_btn') || 'Supprimer mon compte',
      rejectLabel: 'Annuler',
      accept: async () => {
        try {
