        ...
        <div className="auth-form-container">
          <div className="auth-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              <h1 style={{ fontSize: '1.25rem', margin: 0, fontWeight: 800, color: 'var(--text-main)' }}>{t('auth.reset_title')}</h1>
              <p style={{ fontSize: '0.75rem', margin: 0, color: 'var(--text-muted)', lineHeight: 1.3 }}>{t('auth.reset_subtitle')}</p>
            </div>
          </div>
