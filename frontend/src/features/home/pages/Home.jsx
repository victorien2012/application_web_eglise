...
export function Home() {
  ...
  // Logique partagée avec SermonCard : une couverture enregistrée mais
  // introuvable doit basculer sur la miniature YouTube (voir
  // miniaturePredication).
  function imageDe(item) {
    return miniaturePredication(item).source;
  }
                    ...
                    <div className="vf-thumb">
                      {imageDe(item) ? (
                        <img
                          ...
                          loading="lazy"
                          onError={(e) => {
                            const repli = miniaturePredication(item).repli;
